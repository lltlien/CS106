...
def betterEvaluationFunction(currentGameState):
  ...
  score = 1    * currentScore - 1.5 * distanceToClosestFood - 2    * (1./distanceToClosestActiveGhost) - 2    * distanceToClosestScaredGhost - 20 * numberOfCapsulesLeft - 4    * numberOfFoodsLeft
  return score
